...
export default async function Home({searchParams}:{searchParams:Promise<{workspace?:string}>}) {
  ...
  if(!workspaces.length)return <main className="login-card"><div className="wordmark">WORKFORGE<span>OS</span></div><h1>Your account is ready.</h1><p>You need a workspace invitation before you can view business records. Contact your WorkForge administrator.</p><a href="/login">Return to sign in</a></main>;
